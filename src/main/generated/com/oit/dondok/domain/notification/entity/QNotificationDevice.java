...
public class QNotificationDevice extends EntityPathBase<NotificationDevice> {
    ...
    public static final QNotificationDevice notificationDevice = new QNotificationDevice("notificationDevice");
    ...
    public final EnumPath<NotificationPlatform> platform = createEnum("platform", NotificationPlatform.class);
    ...
    public QNotificationDevice(Class<? extends NotificationDevice> type, PathMetadata metadata, PathInits inits) {
