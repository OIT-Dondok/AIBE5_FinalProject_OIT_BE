...
public class QMissionLog extends EntityPathBase<MissionLog> {
  ...
  public final EnumPath<CertificationStatus> certificationStatus =
      createEnum("certificationStatus", CertificationStatus.class);
  ...
  public final EnumPath<ModerationDecisionType> decisionType =
      createEnum("decisionType", ModerationDecisionType.class);

  public final DateTimePath<java.time.LocalDateTime> exifTakenAt =
      createDateTime("exifTakenAt", java.time.LocalDateTime.class);

  public final EnumPath<MissionFailureReason> failureReason =
      createEnum("failureReason", MissionFailureReason.class);
  ...
  public final DateTimePath<java.time.LocalDateTime> moderatorDecidedAt =
      createDateTime("moderatorDecidedAt", java.time.LocalDateTime.class);

  public final StringPath rejectMemo = createString("rejectMemo");

  public final EnumPath<RejectReasonCode> rejectReasonCode =
      createEnum("rejectReasonCode", RejectReasonCode.class);

  public final DateTimePath<java.time.LocalDateTime> serverTime =
      createDateTime("serverTime", java.time.LocalDateTime.class);
  ...
  public QMissionLog(Class<? extends MissionLog> type, PathMetadata metadata, PathInits inits) {
    ...
    this.crewParticipant =
        inits.isInitialized("crewParticipant")
            ...
            : null;
    this.moderator =
        inits.isInitialized("moderator")
            ? new com.oit.dondok.domain.member.entity.QMember(forProperty("moderator"))
            : null;
  }
}
