...
public class QMissionScheduleDay extends EntityPathBase<MissionScheduleDay> {
    ...
    public static final QMissionScheduleDay missionScheduleDay = new QMissionScheduleDay("missionScheduleDay");
    ...
    public QMissionScheduleDay(Class<? extends MissionScheduleDay> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.missionRule = inits.isInitialized("missionRule") ? new QMissionRule(forProperty("missionRule"), inits.get("missionRule")) : null;
    }
