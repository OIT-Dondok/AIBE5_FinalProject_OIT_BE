...
public class QMissionRule extends EntityPathBase<MissionRule> {
  ...
  public final EnumPath<DailySettlementType> dailySettlementType =
      createEnum("dailySettlementType", DailySettlementType.class);

  public final EnumPath<MissionFrequencyType> frequencyType =
      createEnum("frequencyType", MissionFrequencyType.class);
