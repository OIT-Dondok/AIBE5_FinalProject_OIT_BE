...
public class QModerationHistory extends EntityPathBase<ModerationHistory> {
  ...
  public static final QModerationHistory moderationHistory =
      new QModerationHistory("moderationHistory");

  public final StringPath afterState = createString("afterState");

  public final StringPath beforeState = createString("beforeState");

  public final DateTimePath<java.time.LocalDateTime> changedAt =
      createDateTime("changedAt", java.time.LocalDateTime.class);
  ...
  public QModerationHistory(
      Class<? extends ModerationHistory> type, PathMetadata metadata, PathInits inits) {
