...
public class QSettlement extends EntityPathBase<Settlement> {
    ...
    public final DateTimePath<java.time.LocalDateTime> baselineFrozenAt = createDateTime("baselineFrozenAt", java.time.LocalDateTime.class);
    ...
    public final EnumPath<SettlementFailureCode> failureCode = createEnum("failureCode", SettlementFailureCode.class);
    ...
    public final EnumPath<RemainderPolicy> remainderPolicy = createEnum("remainderPolicy", RemainderPolicy.class);
    ...
    public final NumberPath<Long> totalBaseRefundAmount = createNumber("totalBaseRefundAmount", Long.class);

    public final NumberPath<Long> totalLockedAmount = createNumber("totalLockedAmount", Long.class);

    public final NumberPath<Integer> totalParticipants = createNumber("totalParticipants", Integer.class);

    public final NumberPath<Integer> totalRecognizedSuccess = createNumber("totalRecognizedSuccess", Integer.class);

    public final NumberPath<Long> totalRemainderAmount = createNumber("totalRemainderAmount", Long.class);
