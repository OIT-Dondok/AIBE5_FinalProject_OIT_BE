...
public class QSettlementItem extends EntityPathBase<SettlementItem> {
  ...
  public final NumberPath<Integer> excludedSuccessCount =
      createNumber("excludedSuccessCount", Integer.class);
  ...
  public final EnumPath<ParticipantStatusSnapshot> participantStatusSnapshot =
      createEnum("participantStatusSnapshot", ParticipantStatusSnapshot.class);

  public final DateTimePath<java.time.LocalDateTime> periodEndAt =
      createDateTime("periodEndAt", java.time.LocalDateTime.class);

  public final DateTimePath<java.time.LocalDateTime> periodStartAt =
      createDateTime("periodStartAt", java.time.LocalDateTime.class);

  public final com.oit.dondok.domain.point.entity.QPointHistory pointHistory;

  public final NumberPath<Integer> recognizedDatesCount =
      createNumber("recognizedDatesCount", Integer.class);

  public final NumberPath<Integer> recognizedSuccessCount =
      createNumber("recognizedSuccessCount", Integer.class);

  public final NumberPath<Long> refundAmount = createNumber("refundAmount", Long.class);

  public final NumberPath<Long> remainderBonusAmount =
      createNumber("remainderBonusAmount", Long.class);

  public final QSettlement settlement;

  public final NumberPath<java.math.BigDecimal> shareRatio =
      createNumber("shareRatio", java.math.BigDecimal.class);
  ...
  public QSettlementItem(
    ...
    this.crewParticipant =
        inits.isInitialized("crewParticipant")
            ? new com.oit.dondok.domain.crew.entity.QCrewParticipant(
                forProperty("crewParticipant"), inits.get("crewParticipant"))
            : null;
    this.member =
        inits.isInitialized("member")
            ...
            : null;
    this.pointHistory =
        inits.isInitialized("pointHistory")
            ? new com.oit.dondok.domain.point.entity.QPointHistory(
                forProperty("pointHistory"), inits.get("pointHistory"))
            : null;
    this.settlement =
