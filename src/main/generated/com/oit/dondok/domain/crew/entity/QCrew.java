...
public class QCrew extends EntityPathBase<Crew> {
  ...
  public final DateTimePath<java.time.LocalDateTime> hostAgreedAt =
      createDateTime("hostAgreedAt", java.time.LocalDateTime.class);

  public final StringPath hostAgreementSnapshot = createString("hostAgreementSnapshot");

  public final EnumPath<HostPolicyVersion> hostAgreementVersion =
      createEnum("hostAgreementVersion", HostPolicyVersion.class);
  ...
  public final DateTimePath<java.time.LocalDateTime> recruitmentDeadline =
      createDateTime("recruitmentDeadline", java.time.LocalDateTime.class);
  ...
  public QCrew(Class<? extends Crew> type, PathMetadata metadata, PathInits inits) {
    ...
    this.hostMember =
        inits.isInitialized("hostMember")
            ? new com.oit.dondok.domain.member.entity.QMember(forProperty("hostMember"))
            : null;
  }
}
