...
public class QCrewNoticeComment extends EntityPathBase<CrewNoticeComment> {
  ...
  public static final QCrewNoticeComment crewNoticeComment =
      new QCrewNoticeComment("crewNoticeComment");
  ...
  public final EnumPath<CrewNoticeCommentStatus> status =
      createEnum("status", CrewNoticeCommentStatus.class);
  ...
  public QCrewNoticeComment(
      Class<? extends CrewNoticeComment> type, PathMetadata metadata, PathInits inits) {
    super(type, metadata, inits);
    this.crewNotice =
        inits.isInitialized("crewNotice")
            ? new QCrewNotice(forProperty("crewNotice"), inits.get("crewNotice"))
            : null;
    this.member =
