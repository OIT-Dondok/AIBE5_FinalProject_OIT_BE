...
public class QCrewParticipant extends EntityPathBase<CrewParticipant> {
  ...
  public final DateTimePath<java.time.LocalDateTime> lockedAt =
      createDateTime("lockedAt", java.time.LocalDateTime.class);

  public final com.oit.dondok.domain.member.entity.QMember member;

  public final DateTimePath<java.time.LocalDateTime> pendingAt =
      createDateTime("pendingAt", java.time.LocalDateTime.class);

  public final DateTimePath<java.time.LocalDateTime> rejectedAt =
      createDateTime("rejectedAt", java.time.LocalDateTime.class);

  public final com.oit.dondok.domain.point.entity.QPointHistory releasedPointHistory;

  public final EnumPath<CrewParticipantStatus> status =
      createEnum("status", CrewParticipantStatus.class);
  ...
  public QCrewParticipant(
      Class<? extends CrewParticipant> type, PathMetadata metadata, PathInits inits) {
    super(type, metadata, inits);
    this.crew =
        inits.isInitialized("crew") ? new QCrew(forProperty("crew"), inits.get("crew")) : null;
    this.member =
        inits.isInitialized("member")
            ? new com.oit.dondok.domain.member.entity.QMember(forProperty("member"))
            : null;
    this.releasedPointHistory =
        inits.isInitialized("releasedPointHistory")
            ? new com.oit.dondok.domain.point.entity.QPointHistory(
                forProperty("releasedPointHistory"), inits.get("releasedPointHistory"))
            : null;
  }
}
