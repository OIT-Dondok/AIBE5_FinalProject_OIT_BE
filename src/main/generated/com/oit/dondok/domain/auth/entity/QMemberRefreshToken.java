...
public class QMemberRefreshToken extends EntityPathBase<MemberRefreshToken> {
  ...
  public static final QMemberRefreshToken memberRefreshToken =
      new QMemberRefreshToken("memberRefreshToken");
  ...
  public final DateTimePath<java.time.LocalDateTime> revokedAt =
      createDateTime("revokedAt", java.time.LocalDateTime.class);
  ...
  public QMemberRefreshToken(
      Class<? extends MemberRefreshToken> type, PathMetadata metadata, PathInits inits) {
