...
public class QPointHistory extends EntityPathBase<PointHistory> {
  ...
  public final EnumPath<PointReferenceType> referenceType =
      createEnum("referenceType", PointReferenceType.class);

  public final NumberPath<Long> reservedAfter = createNumber("reservedAfter", Long.class);

  public final EnumPath<PointTransactionType> transactionType =
      createEnum("transactionType", PointTransactionType.class);
