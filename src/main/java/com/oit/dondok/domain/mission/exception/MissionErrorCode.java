...
public enum MissionErrorCode implements ErrorCode {
  ...
  INVALID_REVIEW_CATEGORY(HttpStatus.BAD_REQUEST, "유효하지 않은 검토 분류입니다."),
  INVALID_CURSOR(HttpStatus.BAD_REQUEST, "유효하지 않은 커서 값입니다."),
  MISSION_REVIEW_NOT_AVAILABLE_FOR_CREW_STATUS(HttpStatus.CONFLICT, "진행 중인 크루의 인증만 검토할 수 있습니다."),
